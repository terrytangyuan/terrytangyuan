...
imgs <- list(
  ...
  twitter = "https://img.shields.io/badge/X-9.3k-_.svg?style=social&logo=x",
  linkedin = "https://img.shields.io/badge/LinkedIn-17k-_.svg?style=social&logo=linkedin",
  citations = "https://img.shields.io/badge/Citations-9.1k-_.svg?style=social&logo=google-scholar",
  substack = "https://img.shields.io/badge/Substack-743-_.svg?style=social&logo=substack"
)
