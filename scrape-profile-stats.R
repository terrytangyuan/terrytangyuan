...
imgs <- list(
  ...
  linkedin = "https://img.shields.io/badge/LinkedIn-19k-_.svg?style=social&logo=linkedin",
  citations = "https://img.shields.io/badge/Citations-9.4k-_.svg?style=social&logo=google-scholar",
  substack = "https://img.shields.io/badge/Substack-975-_.svg?style=social&logo=substack"
)
